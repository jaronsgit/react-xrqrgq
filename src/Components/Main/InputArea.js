                ...
                <Grid container direction="column" justify="space-between" alignItems="center" style={{width:"100%"}}>
                    ...
                    <Grid item style={{width:"100%"}}>
                        ...
                        <Virtuoso
                            ...
                            totalCount={parsedSentences.length}
                            item={(index) => {
                                return (
                                    <ListItem button key={parsedSentences[index].id} onClick={()=>onSelect(parsedSentences[index].id)}>
                                        <Typography>{parsedSentences[index].input}</Typography>
                                    </ListItem>
                                );
                            }}
                            footer={() => (
